...
{
	tdav_codec_red_t* red = (tdav_codec_red_t*)codec;
...
static const tmedia_codec_plugin_def_t tdav_codec_red_plugin_def_s = 
{
	...
	(/* tmedia_video | tmedia_audio | tmedia_t140*/ tmedia_audio), // FIXME: for now is only supported with T.140
	tmedia_codec_id_red,
	"red",
	"red codec",
	TMEDIA_CODEC_FORMAT_RED,
	tsk_true,
	8000, // rate: FIXME: for now it's only for T.140
